...
- Na tabela acima, `r round(freq_table_carb$"$F$"[1]*100)`% são iguais ou menores que 1 e `r round(freq_table_carb$"$F$"[2]*100)`% são iguais ou menores do que 2; logo, a mediana é 2.
