## ----echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.align='center', out.width="70%"----
...
## ----echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.align='center', out.width="60%"----
